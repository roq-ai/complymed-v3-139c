...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create': {
    ...
    key: 'new-task-created',
    tenantPath: ['organization', 'franchise', 'task'],
    userPath: [],
  },
  'task.update': {
    roles: ['organization-admin'],
  ...
  'franchise.update': {
    roles: ['organization-admin'],
    key: 'new-franchise-assigned',
    tenantPath: ['organization', 'franchise'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['organization-admin'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['organization-admin'];
